<x-splade-toggle>
    ...
    <nav class="bg-white  md:text-sm border dark:bg-gray-900">
        <div class="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
            <div class="flex items-center justify-between py-5 md:block"><a href="/" rel="nofollow">
                    <x-application-logo class="block h-9 w-auto fill-current text-gray-800" />
                </a>
                <div class="md:hidden">
                    <button class="menu-btn text-gray-500 hover:text-gray-800"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="flex-1 items-center mt-8 md:mt-0 md:flex hidden ">
                <ul class="justify-center items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                    <li class="text-gray-700 hover:text-gray-900"><a href="javascript:void(0)" class="block"
                            rel="nofollow">Help</a></li>
                    <li class="text-gray-700 hover:text-gray-900"><a href="route({{ 'contact-us' }})" class="block"
