<div class="relative z-10" x-data="{ state: false }">
    <div class="absolute inset-0 blur-xl h-[580px]"></div>
    <div class="relative">
            ...
            <div class="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 overflow-hidden md:px-8 md:flex">
                <div class="flex-none space-y-5 max-w-xl">
                    ...
                    <h1 class="text-4xl text-gray-800 font-extrabold sm:text-5xl">
                        "Navigate the path to digital organization with a state-of-the-art file repository solution."
                    </h1>
                    <p class="text-gray-800  font-bold">
                        <i> "Initiate your journey to efficient data management now."</i>
                    </p>
