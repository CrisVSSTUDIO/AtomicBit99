<x-app-layout>
    ...
    <x-header-section title="You are viewing {{ $asset->name }}">
        ...
        @if ($filextension == 'csv')
            <Link confirm="Submit to train data" confirm-text="Are you sure you want to submit the csv to be analyzed?"
                confirm-button="Yes" cancel-button="No, I want to stay!"href="{{ route('train-csv', $asset->id) }}"
