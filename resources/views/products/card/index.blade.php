            ...
            <div class="grid   sm:grid-cols-2 lg:grid-cols-4">
                ...
                @forelse ($assets as $asset)
                    ...
                    <x-card title="{{ $asset->name ?? 'No name' }}">
                        @if ($filextension)
                            @switch($filextension)
                                @case($filextension == 'glb')
                                    <model-viewer alt="{{ $asset->name ?? 'No name' }}"
                                        src="{{ asset('storage/' . $asset->upload) }}" ar camera-controls touch-action="pan-y"
                                ...
                                @case($filextension == 'pdf')
                                    <link rel="import" src="{{ asset('storage/' . $asset->upload) }}"
                                ...
                                @default
                                    <img src="{{ asset('storage/' . $asset->upload) }}" alt="{{ $asset->name ?? 'No name' }}"
                        ...
                        <div
                            class="container flex flex-wrap align-center gap-2 md:flex-row sm:flex-col justify-center ">
