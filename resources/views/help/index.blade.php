...
<section class="shadow-xl">
  <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center p-4">
    <div class="mx-auto max-w-xl text-center">
      <h1 class="text-3xl font-extrabold sm:text-5xl">
Need assistance?       <strong class="font-extrabold text-blue-600 p-2 mt-4 sm:block"> We're here to help!</strong>
      </h1>

      <p class="mt-4 sm:text-xl/relaxed">
        Scroll down below to find the typical issues. Or get in touch!
      </p>
...
<section class=" text-gray-900">
  <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
    <div class="mx-auto max-w-lg text-center">
      <h2 class="text-3xl font-bold sm:text-4xl">Tipical issues</h2>

      <p class="mt-4">
        Click on the card/s below to get a customized answer.
      </p>
    </div>
