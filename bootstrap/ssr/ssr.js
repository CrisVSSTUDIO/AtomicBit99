...
`));
  ...
  `, document.head.appendChild(t);
    ...
    const _sfc_main$4 = {
      ...
      setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
          const _component_vue_particles = vueExports.resolveComponent("vue-particles");
          _push(ssrRenderComponent(_component_vue_particles, vueExports.mergeProps({
            id: "tsparticles",
      ...
      methods: {
        createChart() {
          const chart = new ApexCharts(this.$refs.linechart, {
            ...
            xaxis: {
              categories: this.yearCount
              // Use the yearCount data for the x-axis categories
            },
            title: {
              text: "Nº of files per year (Linear Regression)",
              align: "left",
              margin: 10,
              offsetX: 0,
              offsetY: 0,
    ...
    const _sfc_main$2 = {
      ...
      methods: {
        createChart() {
          const chart = new ApexCharts$1(this.$refs.linechart, {
            chart: {
              type: "scatter",
              height: 400
            },
    ...
    const _sfc_main$1 = /* @__PURE__ */ vueExports.defineComponent({
      ...
      setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
          ...
          _push(ssrRenderComponent(vueExports.unref(AccordionRoot), vueExports.mergeProps({
            ...
            default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                ssrRenderList(accordionItems, (item) => {
                  _push2(ssrRenderComponent(vueExports.unref(AccordionItem), {
                    ...
                    default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        _push3(ssrRenderComponent(vueExports.unref(AccordionHeader), { class: "flex" }, {
                          default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(ssrRenderComponent(vueExports.unref(AccordionTrigger), { class: "text-grass11 shadow-mauve6 hover:bg-mauve2 flex h-[45px] flex-1 cursor-default items-center justify-between bg-white px-5 text-[15px] leading-none shadow-[0_1px_0] outline-none group" }, {
                                default: vueExports.withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    ...
                                    return [
                                      vueExports.createVNode("span", null, vueExports.toDisplayString(item.title), 1),
                              ...
                              return [
                                vueExports.createVNode(vueExports.unref(AccordionTrigger), { class: "text-grass11 shadow-mauve6 hover:bg-mauve2 flex h-[45px] flex-1 cursor-default items-center justify-between bg-white px-5 text-[15px] leading-none shadow-[0_1px_0] outline-none group" }, {
                                  default: vueExports.withCtx(() => [
                                    vueExports.createVNode("span", null, vueExports.toDisplayString(item.title), 1),
                                    vueExports.createVNode(_component_Icon, {
                                      icon: "radix-icons:chevron-down",
                        ...
                        _push3(ssrRenderComponent(vueExports.unref(AccordionContent), { class: "text-mauve11 bg-mauve2 data-[state=open]:animate-slideDown data-[state=closed]:animate-slideUp overflow-hidden text-[15px]" }, {
                          default: vueExports.withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`<div class="px-5 py-4"${_scopeId3}>${ssrInterpolate(item.content)}</div>`);
                            } else {
                              return [
                                vueExports.createVNode("div", { class: "px-5 py-4" }, vueExports.toDisplayString(item.content), 1)
                              ];
                            }
                          }),
                          _: 2
                        ...
                        return [
                          vueExports.createVNode(vueExports.unref(AccordionHeader), { class: "flex" }, {
                            default: vueExports.withCtx(() => [
                              vueExports.createVNode(vueExports.unref(AccordionTrigger), { class: "text-grass11 shadow-mauve6 hover:bg-mauve2 flex h-[45px] flex-1 cursor-default items-center justify-between bg-white px-5 text-[15px] leading-none shadow-[0_1px_0] outline-none group" }, {
                                default: vueExports.withCtx(() => [
                                  vueExports.createVNode("span", null, vueExports.toDisplayString(item.title), 1),
                          ...
                          vueExports.createVNode(vueExports.unref(AccordionContent), { class: "text-mauve11 bg-mauve2 data-[state=open]:animate-slideDown data-[state=closed]:animate-slideUp overflow-hidden text-[15px]" }, {
                            default: vueExports.withCtx(() => [
                              vueExports.createVNode("div", { class: "px-5 py-4" }, vueExports.toDisplayString(item.content), 1)
                            ]),
                            _: 2
                ...
                return [
                  (vueExports.openBlock(), vueExports.createBlock(vueExports.Fragment, null, vueExports.renderList(accordionItems, (item) => {
                    return vueExports.createVNode(vueExports.unref(AccordionItem), {
                      key: item.value,
                      class: "focus-within:shadow-mauve12 mt-px overflow-hidden first:mt-0 first:rounded-t last:rounded-b focus-within:relative focus-within:z-10 focus-within:shadow-[0_0_0_2px]",
                      value: item.value
                    }, {
